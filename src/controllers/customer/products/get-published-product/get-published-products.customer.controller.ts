...
/**
 * @swagger
 * /customer/product/published:
 *   get:
 *     summary: Get published products
 *     operationId: GetPublishedProducts
 *     description: Get Published products
 *     parameters:
 *       - in: header
 *         name: x-api-key
 *         schema:
...
export default async (req: Request, res: Response) => {
  ...
  const draftProducts = await productService.getPublishedProducts({
    limit,
    offset,
